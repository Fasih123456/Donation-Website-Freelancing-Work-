    ...
    return (
        ...
        <div class="main body ui container">
                ...
                <div>
                    <Container>
                        <Row>
                            <Col ><Cards src='img/Icons/tool.png' title='Free Towing running or not' text='Regardless of where you are, you can get free towing'/></Col>
                            <Col><Cards src='img/Icons/money-flow.png' title='100% Tax Deductible' text='Greatest tax deduction available.'/></Col>
                            <Col style={{align: "left"}}><Cards src='img/Icons/group-users.png' title='Help Your Community' text='The assurance that your gift supports organizations supporting your communitys residents'/></Col>
                        </Row>
                    </Container>
                </div>

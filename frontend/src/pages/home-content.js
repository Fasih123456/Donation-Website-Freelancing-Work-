        ...
        <div class="row gx-4 gx-lg-5 justify-content-center">
          <div class="col-md-10 col-lg-8 col-xl-7">
            ...
            <div>
              <Row style={{ height: "50%" }}>
                <Col>
                  <h3>Contact Less Towing</h3>
                  <p>
                    Experience the peace of mind with contactless towing. Our donation partners
                    prioritize your health and safety by implementing the following measures:
                  </p>
